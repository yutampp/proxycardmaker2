...
file_put_contents( "database_detail", json_encode($database) );
...
function loadtext( $path ){
  ...
  foreach($lists as $li ){
    $card_detail = pq($li)->html();
    $card_detail = str_replace(["\r\n","\t"],"", $card_detail);
    //echo $card_detail . "\n";
    array_push( $card_details, $card_detail);
    /*
    ...
    */
    ...
    array_push( $cids, $cid );
    array_push( $summary, [$cid, $card_detail ] );
  }
  return $summary;
}
